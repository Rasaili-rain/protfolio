...
export default function Hero() {
  ...
  return (
    <section id="home" ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-20">
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-zinc-950/50 backdrop-blur-sm border border-zinc-800 rounded-2xl p-5 hover:border-blue-500/50 transition-all group/stat">
                      <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-1">3+</div>
