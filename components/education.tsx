        ...
        <div className="space-y-6 mb-20">
          ...
          <div className="space-y-4">
            {education.map((item, index) => (
              <div
                key={index}
                className="flex gap-4 animate-float-up"
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  {index !== education.length - 1 && (
                    <div className="w-0.5 h-16 bg-gradient-to-b from-accent/50 to-transparent mt-2" />
                  )}
                </div>

                {/* Content */}
                <div
                  className="flex-1 pt-1 cursor-pointer"
                  onClick={() =>
            ...
            {certifications.map((cert, index) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <span className="px-2 py-1 text-xs font-medium rounded-full bg-accent/10 text-accent whitespace-nowrap">
                    {cert.year}
                  </span>
                </div>
              </div>
